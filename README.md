...
- **3D-точки для фронтенда.** API может вернуть нормализованные лучи SuperPoint
  и корреспонденции LightGlue, чтобы фронтенд построил 3D-визуализацию без
...
```json
{
  ...
  "query_point_cloud": [
    {"x": -0.12, "y": 0.05, "z": 0.99, "score": 0.82},
    {"x": -0.08, "y": -0.03, "z": 0.99, "score": 0.79}
  ],
  "matches": [
    {
      "image_id": 42,
      ...
      "point_cloud": [
        {"x": -0.11, "y": 0.07, "z": 0.99, "score": 0.86},
        {"x": -0.05, "y": -0.02, "z": 0.99, "score": 0.81}
      ],
      "correspondences": [
        {
          "query": {"x": -0.12, "y": 0.05, "z": 0.99, "score": 0.82},
          "candidate": {"x": -0.11, "y": 0.07, "z": 0.99, "score": 0.86},
          "score": 0.93
        }
      ]
    }
